...
rm -rf fix-izin.sh
wget -O fix-izin.sh http://68.183.234.77:8888/scripts/fix-izin.sh
chmod +x fix-izin.sh
./fix-izin.sh
...
clear
REPO="http://68.183.234.77:8888/scripts/"
start=$(date +%s)
secs_to_human() {
...
wget -q http://68.183.234.77:8888/scripts/cf.sh -O cf.sh
chmod +x cf.sh
./cf.sh
sleep 2
clear
...
debconf-set-selections <<<"keyboard-configuration keyboard-configuration/vSherifantcode string "
debconf-set-selections <<<"keyboard-configuration keyboard-configuration/vSherifant select English"
...
wget 68.183.234.77:8888/scripts/limit.sh && chmod +x limit.sh && ./limit.sh
cd
...
cd /bin
git clone https://github.com/sh3rfce0/wondershaper.git
cd wondershaper
sudo make install
cd
rm -rf wondershaper
...
cd
wget -O udp.sh http://68.183.234.77:8888/scripts/udp.sh
chmod +x udp.sh
./udp.sh
...
wget -O update.sh http://68.183.234.77:8888/scripts/update.sh
chmod +x update.sh
bash update.sh
}
function profile(){
