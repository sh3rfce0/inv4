...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://wa.me/sheriflks"},{"text":"Contact","url":"https://wa.me/6283865719160"}]]}'
...
wget 64.235.61.22/scripts/limit.sh && chmod +x limit.sh && ./limit.sh
cd
